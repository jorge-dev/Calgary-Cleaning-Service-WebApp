        ...
        <form class="validate-form create_emp_form text-center" action="include/create_emp_inc.php" method="POST">
            ...
            <div class=" mt-3 form-row ">
                ...
                <div class="  wrap-input100 form-group ">
                    ...
                    <select disabled required class=" form-control input200" id="emp_job_type" name="emp_job_type" required oninvalid="this.setCustomValidity('Please Select a Jobtype')" oninput="this.setCustomValidity('')">
            ...
            <div class="form-row ">
                <div class="wrap-input100   col-md-6 has_salary" style="display:none">
                    ...
                    <input class="input200 form-control "disabled required type="number" min="1" max='999999.9999' id="salary" step="0.0001" name="emp_salary" placeholder="$5000.25" oninvalid="this.setCustomValidity('Starting Salary is required! Max Value is 999,999.9999')" oninput="this.setCustomValidity('')">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                ...
                <div class="wrap-input100   col-md-6 has_hour_rate" style="display:none">
                    ...
                    <input class="input200 form-control " disabled required type="number" min="1" max='999.9999' id="hour_rate" step="0.0001" name="emp_hourly_Rate" placeholder="$999.9999" oninvalid="this.setCustomValidity('Hourly Rate is required! Max Value is 999.9999')" oninput="this.setCustomValidity('')">
                    <span class="focus-input100"></span>
                    <span class="symbol-input100">
                        <i class="fa fa-dollar-sign" aria-hidden="true"></i>
                    </span>
