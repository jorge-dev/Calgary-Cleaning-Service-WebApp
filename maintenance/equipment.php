...
if (!isset($_SESSION['maint_emp_id'])) {
    ...
    include_once("maintenance/equipment.php");
...
<body>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top">
        <a class="navbar-brand font-weight-bold" href="equipment.php">
            <h3>Equipment</h3>
        </a>
            ...
            <div class="container">
                ...
                if (@$_GET['delete'] == 'success') {
                    ...
                    echo ' 
                            <br/>
                            <div class="alert d-flex justify-content-center bg-success mx-auto alert-dismissible fade show" role="alert">
                                <p class="text-center alert-heading" style ="width:340px;"><strong class="alert-heading">Success!</strong>  <br/> Equipment was succesfully deleted.</p>
                                <button type="button" class="pl-0 pr-2 pt-1 close" data-dismiss="alert" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                                </button>
                           </div>';
    ...
    <script>
        window.history.replaceState({}, document.title, "/" + "471-Project/maintenance/equipment.php");
    </script>
</body>
