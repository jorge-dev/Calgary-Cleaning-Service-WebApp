...
<body>
    <nav class="navbar navbar-expand-md navbar-dark fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item ">
                    <a class="nav-link  text-success" href="equipment_search.php">
    ...
    <main>
        ...
        if (!mysqli_stmt_prepare($stmt, $sql)) {
            header("Location: equipment_search.php?error=sqlErrorSelectEmp");
            exit();
        } else {
    ...
    <script>
        window.history.replaceState({}, document.title, "/" + "471-Project/maintenance/equipment_search.php");
    </script>
</body>
