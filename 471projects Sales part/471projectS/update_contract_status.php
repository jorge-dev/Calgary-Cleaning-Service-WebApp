...
<body>
    ...
    <h1 style="text-align:center; color : rebeccapurple; font-size: 80px;"> Update Contract</h1>





    <form style="text-align: center;" action=" includes/update_contract.db.php" method="POST">
        ...
        <br>
        <br>
         <input style="text-align:center; font-size:50px;" type="text" name="status" placeholder=" status of contract" />
        <br>
        <br>       
         <input style="text-align:center; font-size:50px;" type="text" name="C_id" placeholder=" Customer Id for contract" />
        <br>
        <br>
        <button tyep=" submit" name="submit" style="font-size:50px;">UPDATE</button>
